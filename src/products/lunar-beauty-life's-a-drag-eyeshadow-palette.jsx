  ...
  const data = useStaticQuery(graphql`
    query {
      allMongodbMakeupIslandProducts(
        filter: {
          local: { eq: "lunar-beauty-life's-a-drag-eyeshadow-palette" }
        }
      ) {
        edges {
          node {
      ...
      allFile(
        filter: {
          relativeDirectory: {
            eq: "products/lunar-beauty-life's-a-drag-eyeshadow-palette"
          }
        }
      ) {
        edges {
...
export default LunarBeautyLifesADrag
